...
class DatabaseSeeder extends Seeder
{
	private $arrayPeliculas = array(
		...
		array(
			...
			'poster' => 'https://pics.filmaffinity.com/the_sting-333620255-large.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://img.tviso.com/ES/poster/w430/16/76/16761127da335c2d7ddd2387c20d875f.jpg', 
			'rented' => true, 
		...
		array(
			...
			'year' => '1987', 
			'director' => 'Stanley Kubrick', 
			'poster' => 'https://es.web.img3.acsta.net/c_215_290/medias/nmedia/18/90/15/35/20083253.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://www.proyectoscio.ucv.es/wp-content/uploads/2018/04/poster-de-Blade-Runner.jpg', 
			'rented' => true, 
    ...
    public function seedUsers(){
    	...
    	$u1 = new User;
    	$u1->name = 'roberto';
    	$u1->email = 'roberto@gmail.com';
    	$u1->password = bcrypt('roberto');
    	$u1->save();
    	$u2 = new User;
    	$u2->name = 'alex';
    	$u2->email = 'alex@gmail.com';
    	$u2->password = bcrypt('alex');
    	$u2->save();
    }
